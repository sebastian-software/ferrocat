...
Keep the generated JSON report with your notes when a change is performance-motivated. For publication-grade numbers, use the full `gettext-official-v1` profile on the documented reference host instead.
