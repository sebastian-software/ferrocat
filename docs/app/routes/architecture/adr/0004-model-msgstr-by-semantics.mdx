---
title: "ADR 0004: Model `msgstr` by Semantics Instead of Always Using `Vec<String>`"
description: "Accepted architecture decision record: model msgstr by semantics."
---
