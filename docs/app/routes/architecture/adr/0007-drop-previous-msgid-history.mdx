---
title: "ADR 0007: Do Not Support `previous_msgid` History"
description: "Accepted architecture decision record: drop previous msgid history."
order: 70
---
...
- the current catalog identity is `msgid` plus optional `msgctxt`
- callers may use `msgid` as a stable ID or as real source copy
