---
title: "ADR 0012: Make the High-Level Catalog API ICU-Native by Default and Move Gettext Plurals Behind an Explicit Compat Mode"
description: "Accepted architecture decision record: icu native core and gettext compat semantics."
order: 120
---
...
`IcuNative` means ICU MessageFormat v1 in this ADR. MessageFormat 2 is not an
implicit extension of this mode and should not be accepted through the same
parser or catalog semantics without a separate ADR.
