---
title: "ADR 0011: Add an NDJSON Storage Format for High-Level Catalog Workflows"
description: "Accepted architecture decision record: ndjson catalog storage format."
---
