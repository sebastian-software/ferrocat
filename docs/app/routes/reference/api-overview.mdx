...
| Pseudolocalize final runtime artifacts for UI/layout QA | `pseudolocalize_compiled_catalog_artifact`, `pseudolocalize_compiled_catalog_artifact_with_syntax_policy` |
...
Use `pseudolocalize_compiled_catalog_artifact_with_syntax_policy` when the
