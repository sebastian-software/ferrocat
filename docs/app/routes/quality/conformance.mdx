...
The repository carries a hermetic conformance snapshot under [repository conformance snapshot](https://github.com/sebastian-software/ferrocat/tree/main/conformance), with case definitions in [case definitions](https://github.com/sebastian-software/ferrocat/tree/main/crates/ferrocat-conformance/src/cases).
...
Current snapshot totals as of 2026-07-10:

- `61` source-attributed conformance cases
- `457` concrete assertions checked by the harness
- `56` expected passes
- `5` expected rejects
...
- `icu-official`: `12` cases / `32` assertions
