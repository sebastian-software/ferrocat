...
[Palamedes](https://github.com/sebastian-software/palamedes) is the OSS i18n framework for JavaScript and TypeScript applications. Ferrocat is the Rust-native catalog engine underneath the parts that need strict PO handling, catalog semantics, update workflows, catalog QA, runtime compilation, and storage-format discipline.
