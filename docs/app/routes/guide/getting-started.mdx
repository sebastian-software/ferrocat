...
- Use [API Overview](/reference/api-overview#audit_catalogs) when you want catalog QA for release readiness: missing translations, stale messages, ICU checks, semantic metadata conflicts, and obsolete entries.
