...
- Use [API Overview](/reference/api-overview#catalog-workflows) when you want catalog QA for release readiness: missing translations, stale messages, ICU checks, semantic metadata conflicts, obsolete entries, and visible `fuzzy` flags.
