...
#[test]
fn items_to_catalog_uses_context_aware_keys_by_default() {
    let item = PoItem {
        msgid: String::from("Open"),
        msgctxt: Some(String::from("menu.file")),
        msgstr: vec![String::from("Öffnen")],
        ..PoItem::new(2)
    };
...
#[test]
fn items_to_catalog_can_use_plain_msgid_keys() {
    let item = PoItem {
        msgid: String::from("Open"),
        msgctxt: Some(String::from("menu.file")),
        msgstr: vec![String::from("Öffnen")],
    ...
    let entry = catalog.get("Open").expect("entry should exist");
