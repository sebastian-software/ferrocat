...
## [0.6.0](https://github.com/sebastian-software/ferrocat/compare/ferrocat-v0.5.1...ferrocat-v0.6.0) (2026-03-17)
...
* The following workspace dependencies were updated
  * dependencies
    * ferrocat-icu bumped from 0.5.1 to 0.6.0
    * ferrocat-po bumped from 0.5.1 to 0.6.0
