...
- `MachineTranslationMetadata` and `machine_translation_hash` for AI translation metadata that can be preserved in PO or FCL and removed when the translated text changes
